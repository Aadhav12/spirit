...
const tab_button_scene = preload("res://ui/shop/tab_button.tscn")
const shop_item_scene = preload("res://ui/shop/shop_item.tscn")
const school_button_scene = preload("res://ui/shop/shop_school_button.tscn")
